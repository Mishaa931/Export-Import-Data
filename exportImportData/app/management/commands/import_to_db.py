...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        file_path = 'F:\TMRC_PLRA\PLRA\employee_basic_information_district.csv'

        model = apps.get_model('employee_basic_information', 'District')
        # print(model)
        ...
        for date_field in date_fields:
            if date_field in df.columns:
                df[date_field] = pd.to_datetime(df[date_field], errors='coerce').dt.date
